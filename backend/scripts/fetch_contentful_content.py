        ...
        try:
            with urllib.request.urlopen(req, timeout=timeout) as resp:
                ...
                try:
                    ...
                    print(f"JSON parsing error in Contentful API: {str(e)}. Response preview: {response_text[:200]}...", file=sys.stderr)
                    return {}
...
def main():
    ...
    if args.output:
        ...
        out_path = os.path.join(out_dir, f"cms_content_{os.getpid()}.json")
