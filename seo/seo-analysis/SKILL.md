...
try:
    ...
    print(f'Warning: Could not save personas: {e}', file=sys.stderr)
"
```
...
if os.path.exists(log_path):
    try:
        ...
        print(f"Warning: Could not load audit log, creating new one: {e}", file=sys.stderr)
        existing = []
...
try:
    ...
    print(f"Warning: Could not save audit log: {e}", file=sys.stderr)
```
