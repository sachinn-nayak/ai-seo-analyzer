    ...
    try:
        with urllib.request.urlopen(req, timeout=60) as resp:
            ...
            try:
                ...
                print(f"JSON parsing error in PageSpeed API: {str(e)}. Response preview: {response_text[:200]}...", file=sys.stderr)
                return {}
...
def main():
    ...
    _default_out = os.path.join(tempfile.gettempdir(), f"pagespeed_{os.getpid()}.json")
